...
`ЛИСТ РЕГИСТРАЦИИ ИЗМЕНЕНИЙ 3 <#_gjdgxs>`__

`ПЕРЕЧЕНЬ ДЕЙСТВУЮЩИХ ЛИСТОВ 5 <#_30j0zll>`__

`0 Служебная информация 11 <#_3znysh7>`__

   `0.1 Перечень эксплуатационной документации
   11 <#перечень-эксплуатационной-документации>`__

   `0.2 Назначение Руководства 11 <#назначение-руководства>`__

   `0.3 Обязанности держателя Руководства
   11 <#обязанности-держателя-руководства>`__

   `0.4 Термины и определения 11 <#термины-и-определения>`__

   `0.5 Формы повышения внимания к указаниям Руководства
   12 <#формы-повышения-внимания-к-указаниям-руководства>`__

   `0.6 Порядок внесения изменений в Руководство
   13 <#порядок-внесения-изменений-в-руководство>`__

`1 Общие сведения об аэростате 15 <#общие-сведения-об-аэростате>`__

   `1.1 Назначение аэростата 15 <#назначение-аэростата>`__

   `1.2 Состав аэростата и варианты комплектации
   15 <#состав-аэростата-и-варианты-комплектации>`__

   `1.3 Массы составных частей аэростата
   16 <#массы-составных-частей-аэростата>`__

   `1.4 Эксплуатационные особенности.
   17 <#эксплуатационные-особенности.>`__

   `1.5. <#конструктивные-особенности-и-принципы-полета>`__
   Конструктивные особенности и принципы полета 17

`2. <#эксплуатационные-ограничения>`__ **Эксплуатационные ограничения
19**

   `2.1 Правила выполнения полетов 19 <#правила-выполнения-полетов>`__

   `2.2 Минимальный экипаж 19 <#минимальный-экипаж>`__

   `2.3 Метеоусловия и ожидаемые условия эксплуатации
   19 <#метеоусловия-и-ожидаемые-условия-эксплуатации>`__

   `2.4 Допустимая температура в оболочке
   19 <#допустимая-температура-в-оболочке>`__

   `2.5. <#допустимые-вертикальные-скорости-аэростата>`__ Допустимые
   вертикальные скорости аэростата 19

   `2.6. <#подъемы-на-привязи>`__ Подъемы на привязи 19

   `2.7. <#ограничения-по-массам>`__ Ограничения по массам 20

   `2.8. <#максимальная-высота-полета>`__ Максимальная высота полета 20

   `2.9. <#топливная-система>`__ Топливная система 20

   `2.10. <#ограничения-предельной-и-минимальной-масс>`__ Ограничения
   предельной и минимальной масс 20

   `2.11. <#section-1>`__ Допустимые повреждения и дефекты 21

   `2.12. <#необходимые-приборы-и-оборудование>`__ Необходимые приборы и
   оборудование 21

   `2.13. <#ресурс-аэростата>`__ Ресурс аэростата 21

`3. <#действия-в-особых-и-внештатных-ситуациях>`__ **Действия В ОСОБЫХ И
внештатных ситуациях 23**

   `3.1. <#общие-действия>`__ Общие действия 23

   `3.2. Положение пассажиров в корзине
   23 <#положение-пассажиров-в-корзине>`__

   `3.3. Повышенная термическая активность
   24 <#повышенная-термическая-активность>`__

   `3.4. <#недопустимое-сближение-с-линиями-электропередач>`__
   Недопустимое сближение с линиями электропередач 25

   `3.5. <#контакт-с-линиями-электропередач>`__ Контакт с линиями
   электропередач 26

   `3.6. <#пожар-на-земле>`__ Пожар на земле 26

   `3.7. <#пожар-в-воздухе>`__ Пожар в воздухе 27

   `3.8. <#повреждение-оболочки-в-полете-прогар-оболочки>`__ Повреждение
   оболочки в полете, прогар оболочки 27

   `3.9. <#отказ-блока-горелок-нагревателя-и-топливной-системы>`__ Отказ
   блока горелок (нагревателя) и топливной системы 27

   `3.10. <#вынужденная-посадка-на-лес>`__ Вынужденная посадка на лес 28

   `3.11. <#вынужденная-посадка-на-воду>`__ Вынужденная посадка на воду
   28

   `3.12. <#перегрев-оболочки>`__ Перегрев оболочки 29

   `3.13. <#резкая-потеря-нагрузки>`__ Резкая потеря нагрузки 29

   `3.14. <#попадание-в-сдвиг-ветра>`__ Попадание в сдвиг ветра 29

   `3.15. <#посадка-при-сильном-ветре>`__ Посадка при сильном ветре 30

   `3.16. <#отказ-системы-парашютного-клапана>`__ Отказ системы
   парашютного клапана 30

`4. <#предполетная-подготовка>`__ **Предполетная подготовка 31**

   `4.1. <#планирование-полета>`__ Планирование полета 31

   `4.2. <#меры-безопасности-при-подготовке-к-полету>`__ Меры
   безопасности при подготовке к полету 31

   `4.3. <#ограничение-максимальной-взлетной-массы>`__ Ограничение
   максимальной взлетной массы 31

   `4.4. <#экипировка-пилота-и-пассажиров>`__ Экипировка пилота и
   пассажиров 32

   `4.5. <#требования-к-месту-старта>`__ Требования к месту старта 32

   `4.6. <#подготовка-к-полету-и-сборка-аэростата>`__ Подготовка к
   полету и сборка аэростата 33

`5. <#выполнение-полета>`__ **Выполнение полета 43**

   `5.1. <#взлет>`__ Взлет 43

   `5.2. <#управление-аэростатом>`__ Управление аэростатом 44

   `5.3. <#заход-на-посадку-и-посадка>`__ Заход на посадку и посадка 46

   `5.4. <#специальные-полеты>`__ Специальные полеты 48

`6. <#послеполетные-операции>`__ **Послеполетные операции 53**

`7. <#описание-составных-частей>`__ **Описание составных частей 55**

   `7.1. <#состав-аэростата-и-его-технические-характеристики.>`__ Состав
   аэростата и его технические характеристики. 55

   `7.2. <#оболочка>`__ Оболочка 56

   `7.3. <#гондола>`__ Гондола 58

   `7.4. <#блок-горелок>`__ Блок горелок 59

   `7.5. <#баллоны>`__ Баллоны 60

   `7.6. Приборный блок 61 <#приборный-блок>`__

   `7.7. <#запасной-фал>`__ Запасной фал 62

   `7.8. <#медицинская-аптечка>`__ Медицинская аптечка 62

   `7.9. <#огнетушитель>`__ Огнетушитель 62

   `7.10. <#механизм-отцепки-и-уздечка>`__ Механизм отцепки и уздечка 62

   `7.11. <#другие-составные-части-применяемые-в-полете>`__ Другие
   составные части, применяемые в полете 62

   `7.12. <#наземные-составные-части>`__ Наземные составные части 62

`8. <#эксплуатация-газовых-баллонов>`__ **Эксплуатация газовых баллонов
65**

   `8.1. <#меры-безопасности-при-работах-с-газовыми-баллонами>`__ Меры
   безопасности при работах с газовыми баллонами 65

   `8.2. <#заправка-баллонов>`__ Заправка баллонов 65

   `8.3. <#слив-перелив-газа-из-баллонов>`__ Слив (перелив) газа из
   баллонов 66

`9. <#допустимые-повреждения-и-дефекты-1>`__ **Допустимые повреждения и
дефекты 69**

   `9.1. <#общие-требования>`__ Общие требования 69

   `9.2. <#оболочка-1>`__ Оболочка 69

   `9.3. <#гондола-1>`__ Гондола 70

   `9.4. <#блок-горелок-1>`__ Блок горелок 70

   `9.5. <#газовые-баллоны>`__ Газовые баллоны 70

   `9.6. <#приборный-блок-1>`__ Приборный блок 70

   `9.7. <#привязной-стартовый-запасной-фалы-уздечка>`__ Привязной,
   стартовый, запасной фалы, уздечка 70

`10. <#информация-о-техническом-обслуживании-и-ремонте>`__ **Информация
о техническом обслуживании и ремонте 71**

`11. <#хранение-и-транспортировка>`__ **Хранение и транспортировка 73**

   `11.1. <#хранение-аэростата>`__ Хранение аэростата 73

   `11.2. <#хранение-заправленных-газовых-баллонов>`__ Хранение
   заправленных газовых баллонов 73

   `11.3. <#транспортировка>`__ Транспортировка 74

`12. <#приложения>`__ **Приложения 75**

   `Приложение А. Максимальная взлетная масса аэростата и расчетный
   расход топлива 75 <#_47hxl2r>`__
...
2. .. rubric:: Общие сведения об аэростате
      :name: общие-сведения-об-аэростате

   1. .. rubric:: Назначение аэростата
         :name: назначение-аэростата

      1. Аэростат предназначен для свободных полетов и подъемов на
            привязи. На поверхности оболочки могут располагаться
            тканевые рекламные полотна.
...
-------------------------------------------------
   ...
   - температура окружающей среды выходит за пределы диапазона -20 ― +40
   С;

   - горизонтальная составляющая скорости приземного ветра в месте и во
   время наполнения оболочки, при взлете превышает 7 м/с;
